...
public class LevelTwoLegalMovesClass: LegalMoves
{
	public override MoveClass[] getMoves () {
		MoveClass[] moves = new MoveClass[8];
		moves [0] = new MoveClass (2);
		moves [1] = new MoveClass (18);
		moves [2] = new MoveClass (1);
		moves [3] = new MoveClass (9);
		moves [4] = new MoveClass (-2);
		moves [5] = new MoveClass (-18);
		moves [6] = new MoveClass (-1);
